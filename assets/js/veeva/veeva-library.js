...
com.veeva.clm = {
    ...
    launchSelector: function (presentationSlides, callback) {
        ...
        request =
            'veeva:launchSelector(' + JSON.stringify(presentationSlides) + '),callback(com_veeva_clm_launchSelector)';
    ...
    createMultichannelActivityLine: function (values, callback) {
        ...
        request =
            'veeva:createActivityLine(),value(' + JSON.stringify(values) + '),com_veeva_clm_createActivityLine(result)';
        com.veeva.clm.runAPIRequest(request, callback);
    },
